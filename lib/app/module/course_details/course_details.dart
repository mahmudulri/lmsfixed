...
class _CourseDetailsState extends State<CourseDetails> {
  ...
  @override
  void initState() {
    print("from course details  ${widget.slug}");

    courseDetailsController.fetchcourseDetails(widget.slug.toString());
    curriculumController.fetchInstructorData(widget.slug.toString());
    super.initState();
  }
                    ...
                    ? Flexible(
                        child: Text(
                          courseDetailsController
                              .allcoursedatalist.value.data!.slug,
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      //   height: 250,
                      //   width: screenWidth,
                      //   child: courseDetailsController.isLoading.value == false
                      //       ? YoutubePlayer(
                          ...
                          ? Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: NetworkImage(courseDetailsController
                              ...
                              child: Center(
                                child: InkWell(
                                  onTap: () {
                                    courseDetailsController.allcoursedatalist
                                                .value.data!.introVideoCheck ==
                                            2
                                        ? showDialog(
                                            context: context,
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                setState(() {
                                  selectedIndex = 1;
                                  curriculumController.fetchInstructorData(
